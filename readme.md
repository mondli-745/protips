...
- [Form Helpers — Ruby on Rails](http://guides.rubyonrails.org/form_helpers.html)
- [Pagination library for Rails, Sinatra, Merb, DataMapper, and more](https://github.com/mislav/will_paginate)
- [BaseRails](https://www.baserails.com)
- [Synchronize Associations through Nested Attributes](https://developers.500px.com/synchronize-associations-through-nested-attributes-d95391cf1d99)
- [Open a rails form with Twitter Bootstrap modals (Example)](https://coderwall.com/p/ej0mhg/open-a-rails-form-with-twitter-bootstrap-modals#comment_29635)
- [Tags with Select2](https://stackoverflow.com/questions/49738563/select2-is-not-applied-to-select-element-in-rails-where-do-i-find-the-missing-l)
- [https://rubyplus.com/articles/4231-Tagging-using-Acts-as-Taggable-On-in-Rails-5](https://rubyplus.com/articles/4231-Tagging-using-Acts-as-Taggable-On-in-Rails-5)

# (Rails) Comments

- [Nested Comments With HTML and CSS](https://www.youtube.com/watch?v=gfmmpRt8Wk4)
- [Bootstrap Collapsible nested comments](https://bootsnipp.com/snippets/featured/collapsible-nested-comments)
- [Organise ActiveRecord model into a tree structure](https://github.com/stefankroes/ancestry)
- [Easily and efficiently make your ActiveRecord models support hierarchies](https://github.com/ClosureTree/closure_tree)
...
- [Please share any resources related to modifying an integer to add points and subtract points](https://www.reddit.com/r/rails/comments/2su4ib/please_share_any_resources_related_to_modifying)
- [Allow People To Vote](http://docs.railsbridge.org/intro-to-rails/allow_people_to_vote)
- [Liking Posts (Example)](https://gorails.com/episodes/liking-posts)
- [#364 Active Record Reputation System](http://railscasts.com/episodes/364-active-record-reputation-system)

# DevOps

- [Learn everything DevOps, Cloud and Serverless by completing challenges](https://instruqt.com)
- [Instruqt: Learn DevOps, Cloud, Big Data and coding by completing online courses.](http://instruqt.com)
...
- [https://snowflake.medium.com](https://snowflake.medium.com)
- [Powerful mental tools to help you master tough subjects](https://www.coursera.org/learn/learning-how-to-learn)
- [Learning How To Learn](https://www.quora.com/topic/Learning-How-To-Learn)
- [Some encouragement for you all](https://teamtreehouse.com/community/some-encouragement-for-you-all)
- [Why Learning to Code is So Damn Hard](https://www.vikingcodeschool.com/posts/why-learning-to-code-is-so-damn-hard)
- [Emotion in the User Experience](https://github.com/exercism/docs/blob/master/about/conception/emotional-stages/README.md)
- [Don't learn to code. Learn to think.](http://www.ybrikman.com/writing/2014/05/19/dont-learn-to-code-learn-to-think)
- [Perpetual Learning Talk](http://learningwithjb.com/posts/perpetual-learning-talk)
- [How to Level Up Your Dev Game](https://dev.to/kimberlypilbeam/how-to-level-up-your-dev-game)
...
- [Design lessons for everyone, curated by top designers](https://hackdesign.org)
...
- [How to decide when to use Node.js?](https://stackoverflow.com/questions/5062614/how-to-decide-when-to-use-node-js?rq=1)
...
- [How to setup email verification in FeathersJS](https://blog.feathersjs.com/how-to-setup-email-verification-in-feathersjs-72ce9882e744)
- [Docs.feathersjs.com](https://docs.feathersjs.com)
...
- [Learn Elixir Quickly](https://www.dailydrip.com/pages/pricing?referral=ancient-paper-5284)
- [Culttt.com](http://culttt.com)
- [Phoenix framework](http://phoenixframework.org)
- [Deploy2heroku](http://www.phoenixframework.org/docs/heroku)
- [LearnElixir.tv](https://www.learnelixir.tv/episodes)
- [LearnPhoenix.tv](https://www.learnphoenix.tv/episodes)
- [ElixirCasts](https://elixircasts.io)
- [Elixir Forum](https://elixirforum.com)
- [Learning Resources](https://elixirforum.com/c/learning-resources)
- [Elixir School](https://elixirschool.com/en)
- [Gigalixir vs Heroku](https://gigalixir.readthedocs.io/en/latest/main.html#gigalixir-vs-heroku-feature-comparison)
- [Frameworks, Plugs & Components](https://elixirnation.io)
- [Newest 'elixir' Questions](https://stackoverflow.com/questions/tagged/elixir?sort=newest&pageSize=50)

# Elixir side things

- [simple authentication & authorization in step-by-step tutorial form](https://medium.com/%40andreichernykh/phoenix-simple-authentication-authorization-in-step-by-step-tutorial-form-dc93ea350153)
- [Authentication & Todo app](https://medium.com/%40Stephanbv/elixir-phoenix-lets-code-authentication-todo-application-part-1-599ee94cd04d)
- [Writing a Blog Engine in Phoenix and Elixir](https://hackernoon.com/introduction-fe138ac6079d)
...
- [Plug v1.6.1](https://hexdocs.pm/plug/readme.html)
- [Elixir maps have built in syntax for updating](https://dockyard.com/blog/2016/03/07/til-elixir-maps-have-built-in-syntax-for-updating)
- [Elixir Authentication](https://github.com/ueberauth/guardian)
- [Nested preload in Ecto](https://tkowal.wordpress.com/2016/04/23/nested-preload-in-ecto)
- [Preloading Nested Associations with Ecto](https://robots.thoughtbot.com/preloading-nested-associations-with-ecto)
- [Making Sense of Ecto 2 SQL.Sandbox and Connection Ownership Modes](https://medium.com/%40qertoip/making-sense-of-ecto-2-sql-sandbox-and-connection-ownership-modes-b45c5337c6b7)

# On the go

- [Enki](https://www.producthunt.com/posts/enki)
